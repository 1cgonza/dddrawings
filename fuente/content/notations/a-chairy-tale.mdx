...
import Componente from '@/js/notations/a-chairy-tale/index.astro';

<NotationsTwoCols title={frontmatter.title} slug='a-chairy-tale' description={frontmatter.description} imagen={{ruta: frontmatter.imgName, coleccion: 'notations', alt: `Notations for the film ${frontmatter.title}`}} director={frontmatter.director} year={frontmatter.year} videos={frontmatter.videos} poster={frontmatter.poster}>
...
<div slot="descripcion">
  See: <a id="notes" href="#" title="About">McLaren's notes</a> for information about the context in which McLaren created these notations.

  <span class="disclaimer">This application is created for educational and research purposes only. The Copyright of the source material (images and video) belong to The National Film Board of Canada.</span>
</div>
