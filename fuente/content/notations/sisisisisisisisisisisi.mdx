...
<NotationsCols title={frontmatter.title} slug='sisisisisisisisisisisi' director={frontmatter.director} year={frontmatter.year} videos={frontmatter.videos} poster={frontmatter.poster}>
